...
public class GroceryItemTest {
    ...
    public void testConstructor() {
        GroceryItem item = new GroceryItem("1", "Unnamed", 330, MeasuringUnit.DL, 11);
    ...
    public void testPrice() {
        GroceryItem item = new GroceryItem("1", "Unnamed", 500, MeasuringUnit.GRAM, 10);
    ...
    @Test public void testUnitPriceRounding() {
        GroceryItem item = new GroceryItem("1", "Unnamed", 3.0, MeasuringUnit.KG, 10);
